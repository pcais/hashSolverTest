...
function solveHash() {
    getMsg();
    if(msg == ""){
        msg = "Shutdown Ends as Trump Signs Bill";
    }
    for (i = 0; res === 0; i++) {
...
function level1() {
    regExp = /^0[0-9].*$/;
    document.getElementById("LevelScore").innerHTML = "Hash Level 1";
}
function level2() {
    regExp = /^00[0-9].*$/;
    document.getElementById("LevelScore").innerHTML = "Hash Level 2";
}
function level3() {
    regExp = /^000[0-9].*$/;
    document.getElementById("LevelScore").innerHTML = "Hash Level 3";
}
function level4() {
    regExp = /^0000[0-9].*$/;
    document.getElementById("LevelScore").innerHTML = "Hash Level 4";
}
...
function showResult() {
    ...
    document.getElementById("trys").innerHTML = i;
